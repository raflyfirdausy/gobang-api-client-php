                        ...
                        <tr>
                            ...
                            <td>
                                <button                                   
                                    ...
                                    data-toggle="modal"                                     
                                    type="button" 
                                    class="btnLihatDetail btn btn-primary ">Download Detail
                                </button>          
                                {{-- <button 
...
<script>
  ...
  $(".btnLihatDetail").click(function(){
    ...
    // alert(id);
    window.location = "{{ base_url('riwayat_pengambilan_barang_bukti/download-detail-permintaan-barang-bukti/') }}" + id;
  });
