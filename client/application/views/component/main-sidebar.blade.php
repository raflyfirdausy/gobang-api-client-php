        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-circle-o"></i> Admin POS</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Petugas Kurir</a></li>
              </ul>
            </li>
          <li class="header">Admin Kejaksaan</li>
          <li class="header">Admin Pos</li>
          <li class="treeview">
            <a href="#">
